...
function setup_suporte_widgets() {
    ...
    wp_add_dashboard_widget('custom_help_widget', 'Thiago mendes | Suporte', 'suporte_dashboard_help');
}

function suporte_dashboard_help() {
    echo 'Se você tiver qualquer dúvida ou precisar de ajuda, por favor, entre em contato: <a href="https://web.whatsapp.com/send?phone=5585985948248&amp;text=Ol%C3%A1,%20como%20podemos%20ajuda-lo?" target="_blank" title="Whatsapp">(85) 985948248</a> ou mande um e-mail para <a href="mailto:mendes@convertte.com.br">mendes@convertte.com.br</a>';
}

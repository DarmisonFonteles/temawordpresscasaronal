...
$bg_color           = '#E96815'; //COR DO BAGROUND DA PÁGINA
...
$lg_color           = '#000'; //COR DO BOTÃO PRIMÁRIO
$lg_color_hover     = '#000'; //COR DA BOTÃO PRIMÁRIO HOVER
...
$bt_color           = '#000'; //COR DO BOTÃO SECUNDÁRIO
$bt_color_h         = '#000'; //COR DO BOTÃO SECUNDÁRIO (HOVER)
